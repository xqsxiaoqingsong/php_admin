...
//        return json($banner);
    ...
    public function save(Request $request)
    {
        ...
        $result = Banner::create(['BANNERNAME' => $request->param('BANNERNAME'), 'IMGURL' => $request->param('image')]);
        if ($result) {
...
//        return json($request->param());
    ...
    public function update(Request $request, $id)
    {
        ...
        $result = $banner->where('ID',$id)->update(['BANNERNAME' => $request->param('BANNERNAME'), 'IMGURL' => $request->param('image')]);
